...
def generate_features(stances,dataset,name,bow_vectorizer, tfreq_vectorizer, tfidf_vectorizer):
    ...
    X = np.c_[X_hand, X_polarity, X_refuting_head,X_refuting_body, X_overlap, X_senti_head,X_senti_body,X_senti_cos]
    return X,y
...
if __name__ == "__main__":
    ...
    for fold in fold_stances:
        ...
        clf = GradientBoostingClassifier(n_estimators=270,learning_rate=0.05,max_depth=3, random_state=14128, verbose=True)
